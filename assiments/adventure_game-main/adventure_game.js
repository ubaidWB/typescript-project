...
//                     console.log(chalk.bold.red(`${opponent_game.name} fuel is ${opponent_game.fuel}`));
//                     if (player_game.fuel <= 0) {
//                         console.log(chalk.red.bold.italic("You Lose but try again and best of luck"));
//                         break;
//                     }
//                 } else {
...
//                 console.log(chalk.bold.italic.green(`You drink health protecion; your fuel is ${player_game.fuel}`));
